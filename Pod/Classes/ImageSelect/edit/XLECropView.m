...
#import "UIImage+XLECrop.h"

static const CGFloat MarginTop = 37.0f;
static const CGFloat MarginLeft = 20.0f;

@interface XLECropView () <UIScrollViewDelegate, UIGestureRecognizerDelegate, XLECropRectViewDelegate>

@property (nonatomic) UIScrollView *scrollView;
@property (nonatomic) UIView *zoomingView;
@property (nonatomic) UIImageView *imageView;

@property (nonatomic) XLECropRectView *cropRectView;
...
- (void)commonInit
{
    ...
    self.cropRectView = [[XLECropRectView alloc] init];
...
- (CGRect)cappedCropRectInImageRectWithCropRectView:(XLECropRectView *)cropRectView
{
